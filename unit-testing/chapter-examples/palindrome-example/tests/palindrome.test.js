...
describe("testing isPalindrome",function(){
    test("should return true for a single letter",
    function(){
        expect(isPalindrome('a')).toBe(true);
    });
    test("should return true for a single letter repeated", 
    function(){
    ...
    test("should return true for longer palindrome",
    function(){
        expect(isPalindrome('racecar')).toBe(true);
    });

    test("should return false for a longer nonPalindrome", 
    function(){
        expect(isPalindrome('launchcode')).toBe(false);
    });
    test("should return false for a simple non palindrome", 
    function(){
